...
namespace MiracleList
{
 ...
 public partial class MiracleListProxy : IMiracleListProxy
 {
  ...
  public virtual async System.Threading.Tasks.Task<System.Collections.Generic.IDictionary<string, FileInfoDTO>> FilelistAsync(int id, string mL_AuthToken)
  {
   if (id == null)
    throw new System.ArgumentNullException("id");
   ...
   try
   {
    using (var request_ = new System.Net.Http.HttpRequestMessage())
    {
     ...
     try
     {
      ...
      if (status_ == 200)
      {
       var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.IDictionary<string, FileInfoDTO>>(response_, headers_).ConfigureAwait(false);
