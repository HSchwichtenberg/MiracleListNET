...
namespace Web.Samples_BW.Systeminformationen
{
 public partial class SystemInfoDemo
 {
  ...
  protected override void OnInitialized()
  {
   ...
   Ausgabe2 += "In Blazor Webassembly gibt es keinen Zugriff auf den HttpContext, weil es einen solchen dort nicht gibt! Dies ist auch logisch, da der HttpContext Informationen über den Webserver und die aktuelle HTTP-Anfrage liefert. Blazor Webassembly läuft aber im Browser ohne HTTP-Interaktion. Es können lediglich HTTP-Anfragen von Blazor Webassembly ausgehen, aber keine HTTP-Anfragen bei Blazor Webassembly eingehen.";
